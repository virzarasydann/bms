...
$(function () {
    ...
    const urls = {
        index: window.kategoriProjectIndexUrl,
        store: window.kategoriProjectStoreUrl,
        update: window.kategoriProjectUpdateUrl
    };

    new KategoriProjectModule(permissions, urls);
});
