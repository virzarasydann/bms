    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h1 class="text-xl mb-3">Data Kategori Penerimaan</h1>
                        <div class="card">
    ...
    {{-- <script>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ordering: false,
                responsive: true,
                ajax: "{{ route('kategoriPemasukan.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
       ...
       $(document).on('click', '#edit-button', function() {
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('kategoriPemasukan.update', ['kategoriPemasukan' => ':id']) }}'.replace(':id', id) :
                '{{ route('kategoriPemasukan.store') }}';
